resource "signalfx_detector" "concurrent_queries" {
  ...
  program_text = <<-EOF
    ...
    signal = data('query/count', ${module.filter-tags.filter_custom})${var.concurrent_queries_aggregation_function}.${var.concurrent_queries_transformation_function}(over='${var.concurrent_queries_transformation_window}').publish('signal')
...
resource "signalfx_detector" "execution_time" {
  ...
  program_text = <<-EOF
    from signalfx.detectors.aperiodic import conditions
    signal = data('query/execution_times', ${module.filter-tags.filter_custom})${var.execution_time_aggregation_function}.${var.execution_time_transformation_function}(over='${var.execution_time_transformation_window}').publish('signal')
...
resource "signalfx_detector" "scanned_bytes" {
  ...
  program_text = <<-EOF
    from signalfx.detectors.aperiodic import conditions
    signal = data('query/scanned_bytes', ${module.filter-tags.filter_custom})${var.scanned_bytes_aggregation_function}.${var.scanned_bytes_transformation_function}(over='${var.scanned_bytes_transformation_window}').publish('signal')
...
resource "signalfx_detector" "scanned_bytes_billed" {
  ...
  program_text = <<-EOF
    from signalfx.detectors.aperiodic import conditions
    signal = data('query/scanned_bytes_billed', ${module.filter-tags.filter_custom})${var.scanned_bytes_billed_aggregation_function}.${var.scanned_bytes_billed_transformation_function}(over='${var.scanned_bytes_billed_transformation_window}').publish('signal')
...
resource "signalfx_detector" "available_slots" {
  ...
  program_text = <<-EOF
    from signalfx.detectors.aperiodic import conditions
    signal = data('slots/total_available', ${module.filter-tags.filter_custom})${var.available_slots_aggregation_function}.${var.available_slots_transformation_function}(over='${var.available_slots_transformation_window}').publish('signal')
...
resource "signalfx_detector" "stored_bytes" {
  ...
  program_text = <<-EOF
    from signalfx.detectors.aperiodic import conditions
    signal = data('storage/stored_bytes', ${module.filter-tags.filter_custom})${var.stored_bytes_aggregation_function}.${var.stored_bytes_transformation_function}(over='${var.stored_bytes_transformation_window}').publish('signal')
...
resource "signalfx_detector" "table_count" {
  ...
  program_text = <<-EOF
    from signalfx.detectors.aperiodic import conditions
    signal = data('storage/table_count', ${module.filter-tags.filter_custom})${var.table_count_aggregation_function}.${var.table_count_transformation_function}(over='${var.table_count_transformation_window}').publish('signal')
...
resource "signalfx_detector" "uploaded_bytes" {
  ...
  program_text = <<-EOF
    from signalfx.detectors.aperiodic import conditions
    signal = data('storage/uploaded_bytes', ${module.filter-tags.filter_custom})${var.uploaded_bytes_aggregation_function}.${var.uploaded_bytes_transformation_function}(over='${var.uploaded_bytes_transformation_window}').publish('signal')
...
resource "signalfx_detector" "uploaded_bytes_billed" {
  ...
  program_text = <<-EOF
    from signalfx.detectors.aperiodic import conditions
    signal = data('storage/uploaded_bytes_billed', ${module.filter-tags.filter_custom})${var.uploaded_bytes_billed_aggregation_function}.${var.uploaded_bytes_billed_transformation_function}(over='${var.uploaded_bytes_billed_transformation_window}').publish('signal')
