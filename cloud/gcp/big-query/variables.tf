...
variable "concurrent_queries_transformation_function" {
  description = "Transformation function for concurrent_queries detector (mean, min, max)"
  type        = string
  default     = "mean"
}

variable "concurrent_queries_transformation_window" {
  description = "Transformation window for concurrent_queries detector (i.e. 5m, 20m, 1h, 1d)"
  type        = string
  default     = "5m"
}
...
variable "execution_time_transformation_function" {
  description = "Transformation function for execution_time detector (mean, min, max)"
  type        = string
  default     = "mean"
}

variable "execution_time_transformation_window" {
  description = "Transformation window for execution_time detector (i.e. 5m, 20m, 1h, 1d)"
  type        = string
  default     = "5m"
}
...
variable "scanned_bytes_transformation_function" {
  description = "Transformation function for scanned_bytes detector (mean, min, max)"
  type        = string
  default     = "mean"
}

variable "scanned_bytes_transformation_window" {
  description = "Transformation window for scanned_bytes detector (i.e. 5m, 20m, 1h, 1d)"
  type        = string
  default     = "4h"
}
...
variable "scanned_bytes_billed_transformation_function" {
  description = "Transformation function for scanned_bytes_billed detector (mean, min, max)"
  type        = string
  default     = "mean"
}

variable "scanned_bytes_billed_transformation_window" {
  description = "Transformation window for scanned_bytes_billed detector (i.e. 5m, 20m, 1h, 1d)"
  type        = string
  default     = "4h"
}
...
variable "available_slots_transformation_function" {
  description = "Transformation function for available_slots detector (mean, min, max)"
  type        = string
  default     = "mean"
}

variable "available_slots_transformation_window" {
  description = "Transformation window for available_slots detector (i.e. 5m, 20m, 1h, 1d)"
  type        = string
  default     = "5m"
}
...
variable "stored_bytes_transformation_function" {
  description = "Transformation function for stored_bytes detector (mean, min, max)"
  type        = string
  default     = "mean"
}

variable "stored_bytes_transformation_window" {
  description = "Transformation window for stored_bytes detector (i.e. 5m, 20m, 1h, 1d)"
  type        = string
  default     = "5m"
}
...
variable "table_count_transformation_function" {
  description = "Transformation function for table_count detector (mean, min, max)"
  type        = string
  default     = "mean"
}

variable "table_count_transformation_window" {
  description = "Transformation window for table_count detector (i.e. 5m, 20m, 1h, 1d)"
  type        = string
  default     = "4h"
}
...
variable "uploaded_bytes_transformation_function" {
  description = "Transformation function for uploaded_bytes detector (mean, min, max)"
  type        = string
  default     = "mean"
}

variable "uploaded_bytes_transformation_window" {
  description = "Transformation window for uploaded_bytes detector (i.e. 5m, 20m, 1h, 1d)"
  type        = string
  default     = "4h"
}
...
variable "uploaded_bytes_billed_transformation_function" {
  description = "Transformation function for uploaded_bytes_billed detector (mean, min, max)"
  type        = string
  default     = "mean"
}

variable "uploaded_bytes_billed_transformation_window" {
  description = "Transformation window for uploaded_bytes_billed detector (i.e. 5m, 20m, 1h, 1d)"
  type        = string
  default     = "4h"
}
