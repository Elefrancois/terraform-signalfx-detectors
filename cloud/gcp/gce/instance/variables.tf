...
variable "disk_throttled_bps_transformation_function" {
  description = "Transformation function for disk_throttled_bps detector (mean, min, max)"
  type        = string
  default     = "min"
}

variable "disk_throttled_bps_transformation_window" {
  description = "Transformation window for disk_throttled_bps detector (i.e. 5m, 20m, 1h, 1d)"
  type        = string
  default     = "15m"
}
...
variable "disk_throttled_ops_transformation_function" {
  description = "Transformation function for disk_throttled_ops detector (mean, min, max)"
  type        = string
  default     = "min"
}

variable "disk_throttled_ops_transformation_window" {
  description = "Transformation window for disk_throttled_ops detector (i.e. 5m, 20m, 1h, 1d)"
  type        = string
  default     = "15m"
}
